...
\chapter{Methods}
	\section{Programs}
		...
		\subsection{MySQL}
			\include{inc/results/database-advantages}
	\section{What have I done} % TODO ???
		\subsection{Perl programming}
\chapter{Results}
	\include{inc/methods/methods}
	\section{Graph}
	\section{Algorithm}
		\subsection{Analysis}
			\include{inc/results/algorithm-analysis}
		\subsection{Reporting}
			\include{inc/results/algorithm-reporting}
	\section{Implementation decisions}
	\section{Database design}
		\include{inc/results/database-structure}
