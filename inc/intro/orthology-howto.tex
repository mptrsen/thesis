...
\citeyearpar{needleman1970}, Smith-Waterman \citeyearpar{smith1981}, or
\nomenclature{BLAST}{Basic local alignment search tool} \citep{altschul1990},
and clusters of orthologous genes are created
...
question must be \emph{bidirectional best hits}
(\nomenclature{BBH}{Bidirectional best hits}), also called reciprocal best hits
(\nomenclature{RBH}{Reciprocal best hit}).  Since orthology is also a symmetric
relation, this makes sense \todo{rephrase}.
